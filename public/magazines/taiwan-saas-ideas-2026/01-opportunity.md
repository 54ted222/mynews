...
```mermaid
flowchart TD
  A[你有強 domain / 產業網?] -->|有, 而且是製造業| B[切角二：製造業 AI agent]
  A -->|有, 其他 SMB 場景| C[切角一：SMB 垂直 SaaS]
  A -->|沒有 domain 優勢| D{你有內容 / 英文社群?}
  D -->|有| E[切角三：全球 niche]
  D -->|沒有, 但能獨立開發| F[切角四：一人產品]
  D -->|都沒有| G[先去累積其中一項]
```
